...
--näitab tabelisisu, kui kasutaja sisestab gender(sugu) ja departmenID
...
--proceduur mis ei tööta korrektselt. tulemuses annab üks ja saama nimi
--peame lisama where 
...
rtrim(ltrim(Name)) + ' ' + Gender as FullName
from Employees
